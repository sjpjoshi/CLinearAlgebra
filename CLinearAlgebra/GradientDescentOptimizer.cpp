...
GradientDescentOptimizer::~GradientDescentOptimizer() {} // ~GradientDescentOptimizer

void GradientDescentOptimizer::setObjectiveFunction(function<double(vector<double>*)> objective_function) {
	objective_function_ = objective_function;

} // setObjectiveFunction

void GradientDescentOptimizer::setInitialPoint(const vector<double> initial_point) {
...
void GradientDescentOptimizer::setStepSize(double step_size) {
	step_size_ = step_size;

} // setStepSize

void GradientDescentOptimizer::setMaxIterations(int max_iterations) {
	max_iterations_ = max_iterations;

} // setMaxIterations

void GradientDescentOptimizer::setGradientThreshold(double gradient_threshold) {
	gradient_threshold_ = gradient_threshold;

} // setGradientThreshold

bool GradientDescentOptimizer::Optimize(vector<double>* function_location, double* function_value) {
...
double GradientDescentOptimizer::ComputeGradient(int dimension) {
...
vector<double> GradientDescentOptimizer::ComputeGradientVector() {
...
double GradientDescentOptimizer::ComputeGradientMagnitude(vector<double> gradient_vector) {
